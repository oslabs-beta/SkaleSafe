...
const Footer = () => {
    ...
    const footerIcons: [React.ReactElement, string][] = [[<AiFillGithub size={40} id ='gitHubButton' className='fill-honeydew' />, "https://github.com/oslabs-beta/SkaleSafe#readme"], [<AiFillLinkedin id='linkedInButton' size={40} className="fill-honeydew"/>, "https://www.linkedin.com/company/skalesafe"]]
