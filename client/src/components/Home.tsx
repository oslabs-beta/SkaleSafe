...
const Home =() => {
    ...
    return (
        <div id="home" className="h-[48rem] w-screen bg-gradient-to-tr from-teal-blue flex flex-row items-center justify-evenly">
            <h1 id='eleh1' className='text-6xl text-honeydew leading-relaxed tracking-wide m-0 p-0'>Auto-scaling<br/> made <span id='elespan' className='text-primary-color underline underline-offset-4 capitalize'>easier</span></h1>
