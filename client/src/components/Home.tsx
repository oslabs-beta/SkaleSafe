...
const Home =() => {
    return <div id="home" className="h-[48rem] w-screen bg-gradient-to-tr from-prussian-blue/70 to-teal-blue/70 flex flex-row items-center justify-center gap-20">
